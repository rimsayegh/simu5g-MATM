...
#ifndef APPS_MEC_SAFETY_PACKETS_SAFETYPACKET_TYPES_H_
#define APPS_MEC_SAFETY_PACKETS_SAFETYPACKET_TYPES_H_


#define START_PINGPONG "SendingData"
#define ANS_PINGPONG "SendingPong"
#define PINGPONG_PACKET "DataPacket"
