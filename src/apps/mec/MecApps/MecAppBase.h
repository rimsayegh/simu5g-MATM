...
class  MecAppBase : public omnetpp::cSimpleModule, public inet::TcpSocket::ICallback
{
  protected:
    ...
    */
    ...
    //Added by ESME-L2S
    omnetpp::simsignal_t processingDelay_;
    omnetpp::simtime_t processingDelaySum;
    long pnrReceived;

    //Added by ESME-L2S
    omnetpp::simsignal_t processingVideoDelay_;
    omnetpp::simtime_t processingVideoDelaySum;
    long pnbReceived;
