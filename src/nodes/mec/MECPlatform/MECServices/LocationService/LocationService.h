...
// remember that location has access to the service registry and mec platform - check mecserviceBase
//class Location;
...
class LocationService: public MecServiceBase
{
  ...
  public:
    ...
    //L2S-ESME
    // Declaration of the method to notify the orchestrator for migration
