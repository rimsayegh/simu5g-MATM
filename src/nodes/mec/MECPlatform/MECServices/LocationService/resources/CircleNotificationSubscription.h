...
//        nlohmann::ordered_json toJson(std::vector<MacCellId>& cellsID, std::vector<MacNodeId>& uesID) const;
        ...
        //L2S-ESME
        MacNodeId getVID() const{ return vID;}
        //LocationUtils::EnteringLeavingCriteria getCriteria() const {return actionCriteria}

        int mecAppID; //L2S-ESME

        int count; //L2S-ESME
        int getAPPID() const{ return mecAppID;} //L2S-ESME
        int getcount() const{ return count;} //L2S-ESME



        std::string getActionCriteria() const { return isEnter; }
        //L2S-ESME
        //LocationUtils::EnteringLeavingCriteria actionCriteria; // public to read the actionCriteria in LocationService
    ...
    protected:
        ...
        MacNodeId vID; //L2S-ESME

        std::string isEnter = "No"; //L2S-ESME
